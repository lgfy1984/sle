        ...
        if (dataSet.getColors().size() > 1) {
            ...
            if (e1 != null) {
                ...
                for (int x = mXBounds.min; x <= mXBounds.range + mXBounds.min; x++) {
                    ...
                    if(e1.getData().toString().equals("") ) continue;
//                    System.out.println("^^^^^^^^^^^^^^^^"+j);
                    mLineBuffer[j++] = e1.getX();
                    mLineBuffer[j++] = e1.getY() * phaseY;


//                    System.out.println("-----------e1----------"+e1.getX()+"-----------e1----------y"+e1.getY());
                    ...
                    if(!e2.getData().toString().equals("")){
                    mLineBuffer[j++] = e2.getX();
                    mLineBuffer[j++] = e2.getY() * phaseY;
                    }
                    else{
//                        int temp=0;
                        for(int m = x+1; m<= mXBounds.range + mXBounds.min; m++){
                            e2 = dataSet.getEntryForIndex(m);
                            if(!e2.getData().toString().equals("")){
                                mLineBuffer[j++] = e2.getX();
                                mLineBuffer[j++] = e2.getY() * phaseY;
//                                temp = m;
...
//                        x=temp;
                    ...
                    System.out.println("+++++++++++e2+++++++++++++"+e2.getX()+"+++++++++++e2++++++++++++x"+e2.getY());
                }
        ...
        if (isDrawingValuesAllowed(mChart)) {
            ...
            for (int i = 0; i < dataSets.size(); i++) {
                ...
                for (int j = 0; j < positions.length; j += 2) {
                    ...
                    if(!entry.getData().toString().equals("")){
    ...
    protected void drawCircles(Canvas c) {
        ...
        for (int i = 0; i < dataSets.size(); i++) {
            ...
            for (int j = mXBounds.min; j <= boundsRangeCount; j++) {
                ...
                if (e.getData().toString().equals("")) continue;
