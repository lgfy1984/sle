...
import com.qmh.sle.adapter.CommitDiffAdapter;
...
import com.qmh.sle.interfaces.OnStatusListener;
...
//        } else {
//            String faceurl = SleApi.NO_API_BASE_URL + portrait;
...
//        }
    ...
    private void loadDatasCode(final boolean isRefresh) {
        ...
        SleApi.getCommitDiffList(mProject.getId(), mCommit.getId(), new HttpCallback() {
            @Override
