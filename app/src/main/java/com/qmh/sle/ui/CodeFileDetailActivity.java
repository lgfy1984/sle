...
import com.qmh.sle.common.FileUtils;
import com.qmh.sle.common.UIHelper;
import com.qmh.sle.ui.baseactivity.BaseActivity;
import com.qmh.sle.utils.DialogHelp;
import com.qmh.sle.utils.JsonUtils;
import com.qmh.sle.utils.MarkdownUtils;
import com.qmh.sle.utils.SourceEditor;
...
public class CodeFileDetailActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        url_link = SleApi.NO_API_BASE_URL + mProject.getOwner().getUsername()
                + "/" + mProject.getPath() + "/"
                + "blob" + "/" + mRef + "/" + mPath;
    ...
    private void loadCode(final String projectId, final String path,
        ...
        SleApi.getCodeFileDetail(projectId, path, ref_name, new HttpCallback() {
            @Override
