...
import com.qmh.sle.ui.CodeFileDetailActivity;
import com.qmh.sle.ui.CommitDetailActivity;
import com.qmh.sle.ui.CommitFileDetailActivity;
import com.qmh.sle.ui.CountryActivity;
import com.qmh.sle.ui.IssueDetailActivity;
import com.qmh.sle.ui.LoginActivity;
import com.qmh.sle.ui.MainActivity;
import com.qmh.sle.ui.MyInfoDetailActivity;
import com.qmh.sle.ui.NewIssueActivity;
import com.qmh.sle.ui.NewPatientActivity;
import com.qmh.sle.ui.NewPatientActivity2;
import com.qmh.sle.ui.NewPatientActivity3;
import com.qmh.sle.ui.NewPatientActivity4;
import com.qmh.sle.ui.NewPatientActivity5;
import com.qmh.sle.ui.NewPatientActivity6;
import com.qmh.sle.ui.NotificationActivity;
import com.qmh.sle.ui.PatientDActivity;
import com.qmh.sle.ui.ProjectActivity;
import com.qmh.sle.ui.ProjectReadMeActivity;
import com.qmh.sle.ui.ProjectSomeInfoListActivity;
import com.qmh.sle.ui.SearchActivity;
import com.qmh.sle.ui.UserInfoActivity;
import com.qmh.sle.utils.T;

import java.io.ByteArrayOutputStream;
import java.io.File;

import static com.qmh.sle.common.Contanst.PATIENT;
import static com.qmh.sle.common.Contanst.PATIENTID;
import static com.qmh.sle.common.Contanst.PROJECT;
import static com.qmh.sle.common.Contanst.PROJECTID;
...
public class UIHelper {
     ...
     * 显示病人SLE的列表
     */
    public static void showPatientSleList(Context context, SPatient patient,
                                         String patientId) {
        Intent intent = new Intent(context, PatientDActivity.class);
        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        Bundle bundle = new Bundle();
        bundle.putSerializable(Contanst.PATIENT, patient);
        bundle.putString(Contanst.PATIENTID, patientId);
        intent.putExtras(bundle);
        context.startActivity(intent);
    }
    /**
     * 显示病人SLE的详情
     */
    public static void showPatientDetail(Context context, SPatientD sPatientD, SPatient sPatient) {
        Intent intent = new Intent(context, NewPatientActivity.class);
        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        Bundle bundle = new Bundle();
        bundle.putSerializable(Contanst.PATIENTD, sPatientD);
        bundle.putSerializable(Contanst.PATIENT, sPatient);
        bundle.putString(Contanst.PATIENTFlAG, "1");
        intent.putExtras(bundle);
        context.startActivity(intent);
    }/**
     * 显示病人SLE INDEX的详情
     */
    public static void showIndexDetail(Context context, SPatientD sPatientD, SPatient sPatient) {
        Intent intent = new Intent(context, NewPatientActivity2.class);
        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        Bundle bundle = new Bundle();
        bundle.putSerializable(Contanst.PATIENTD, sPatientD);
        bundle.putSerializable(Contanst.PATIENT, sPatient);
    ...
    public static void showNewPatient(Context context,String pat_flag) {
        Intent intent = new Intent(context, NewPatientActivity.class);
        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        Bundle bundle = new Bundle();
        bundle.putString(Contanst.PATIENTFlAG, pat_flag);
        intent.putExtras(bundle);
        context.startActivity(intent);
    }

    public static void showNewPatient2(Context context,String id,String pat_flag) {
        Intent intent = new Intent(context, NewPatientActivity2.class);
        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        Bundle bundle = new Bundle();
        bundle.putString(Contanst.PATIENTFlAG, pat_flag);
        bundle.putString(Contanst.PATIENTID, id);
        intent.putExtras(bundle);
        context.startActivity(intent);
    }

    public static void showNewPatient3(Context context,String pat_flag) {
        Intent intent = new Intent(context, NewPatientActivity3.class);
        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        Bundle bundle = new Bundle();
        bundle.putString(Contanst.PATIENTFlAG, pat_flag);
        intent.putExtras(bundle);
    ...
    public static void showNewPatient4(Context context,String pat_flag) {
        Intent intent = new Intent(context, NewPatientActivity4.class);
        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        Bundle bundle = new Bundle();
        bundle.putString(Contanst.PATIENTFlAG, pat_flag);
        intent.putExtras(bundle);
    ...
    public static void showNewPatient5(Context context,String pat_flag) {
        Intent intent = new Intent(context, NewPatientActivity5.class);
        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        Bundle bundle = new Bundle();
        bundle.putString(Contanst.PATIENTFlAG, pat_flag);
        intent.putExtras(bundle);
    ...
    public static void showNewPatient6(Context context,String pat_flag) {
        Intent intent = new Intent(context, NewPatientActivity6.class);
        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        Bundle bundle = new Bundle();
        bundle.putString(Contanst.PATIENTFlAG, pat_flag);
        intent.putExtras(bundle);
     ...
     * @param context
     */
    public static void showCountry(Context context) {
     ...
     * @param context
     */
    public static void showSearch(Context context,String departid) {
     ...
     * @param context
     */
    public static void goMainActivity(Context context,Session session) {
        Intent intent = new Intent(context, MainActivity.class);
        Bundle bundle = new Bundle();
        bundle.putSerializable(Contanst.USER, session);
        intent.putExtras(bundle);
        context.startActivity(intent);
    }
    ...
    public static void sendBroadCast(Context context, int count) {
        if (!((AppContext) context.getApplicationContext()).isLogin()
                || count == 0)
            return;
        Intent intent = new Intent("com.qmh.sle.action.APPWIDGET_UPDATE");
