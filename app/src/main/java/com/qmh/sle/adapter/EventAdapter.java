...
import com.qmh.sle.utils.RecyclerList;
...
//        });
        ...
        SpannableString title = UIHelper.parseEventTitle(event
                .getAuthor().getRealname(), event.getProject().getOwner().getRealname()
    ...
    private void addCommitItem(LinearLayout layout, Commit commit) {
        ...
        if (commit != null) {
            ...
            if (commit.getAuthor() != null) {
                ((TextView) v.getChildAt(1)).setText(commit.getAuthor().getRealname());
            }
